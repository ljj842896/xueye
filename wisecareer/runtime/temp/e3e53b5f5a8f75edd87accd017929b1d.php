<?php /*a:1:{s:70:"D:\ljj\PHPTutorial\WWW\wisecareer\application\fx\view\index\login.html";i:1545968346;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="//www.wisecareer.org/js/layer/mobile/need/layer.css"/>
     <script src="/static/fx/js/com.min.js"></script> 
    <script src="/static/fx/js/base.min.js"></script> 
...
<div id="dHead">
    <div class="head">
        <h1 style="font-family:Arial,'微软雅黑', Helvetica, sans-serif;">分销管理登录</h1>
    </div>
</div>
        ...
        <div class="inner" style="background: none">
            ...
            <div id="user_login">
                <form method="post" action="/login/login/"  id="frmlogin" name="frmlogin">
                    ...
                    <h4><span><a href="password.html">忘记密码</a></span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span><a href="reg.html">免费注册</a></span></h4><br/>
...
<script>
    var userid='<?php echo htmlentities($userid); ?>';
    var sessiontype = '<?php echo htmlentities($sessiontype); ?>';
//    function tourist() {
//        $.post( "/user/logout")
